 ...
 */
export function createCodexEngine(config) {
    ...
    return {
        ...
        async invoke(request) {
            ...
            if (result.code !== 0) {
                return fail(`codex exited ${result.code}: ${(result.stderr || result.stdout).trim().slice(0, 600)}`, result.stdout, result.durationMs);
            }
